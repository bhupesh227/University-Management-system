...
const BookReceipt = (props: Props) => {
  ...
  const handleDownload = async (e: React.MouseEvent) => {
    ...
    if (ticket) {
      ...
      // Save the PDF
      pdf.save("BorrowClub_Ticket.pdf");
    ...
    <>
      ...
      <section id="book-ticket">
        <div className="flex items-center gap-2 px-8">
          <Image
            src="/icons/BorrowClub.svg"
            alt="logo"
            width={50}
            height={40}
            className="object-contain bg-orange-400 rounded-lg"
          />
          <p className="text-2xl font-semibold text-white">BorrowClub</p>
        </div>

        <div className="mt-4 px-8">
          <h3 className="text-2xl font-bold text-white">Borrow Receipt</h3>

          <p className="mt-2 text-base text-light-700">
        ...
        <div className="my-7 h-px w-full border-dotted bg-light-100/10" />
        ...
        <div className="relative" id="book-divider">
          <div />
          <div className="my-4 h-px w-full bg-light-100/10 " />
          <div />
        </div>
        ...
        <div className="px-8">
          ...
          <ul className="mt-2 list-disc pl-5">
            ...
            <li className="text-base text-light-700">
              Lost or damaged books will charge replacement costs.
            </li>
          </ul>
        </div>

        <div className="my-5 h-px w-full bg-light-100/10" />

        <div className="px-8 text-center text-light-700">
          <p>
            Thank you for using{" "}
            <span className="font-semibold text-light-200">BorrowClub</span>. For
            any questions or concerns, please contact us at{" "}
            <span className="font-semibold text-light-200">
              contact@bhupeshbora.in
            </span>
          </p>
        </div>
